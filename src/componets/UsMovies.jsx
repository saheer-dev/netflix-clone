...
export default function UsMovies() {
  ...
  useEffect(() => {
    axios.get(
        "https://api.themoviedb.org/3/movie/popular?api_key=efb536b72f026a1ee09ebca3b1a7abff"
      )
      .then((res) => {
  ...
  return (
    ...
    <div className=" w-screen p-4  bg-black md:-mt-[5rem] mb-[3rem]">
        <div className="flex justify-between items-center">
       
      <h1 className=" text-slate-300 mb-4 z-40">Us Movies</h1>
